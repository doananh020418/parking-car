...
# 104 "C:\\Program Files\\Microchip\\xc8\\v2.30\\pic\\include\\c90\\stdlib.h" 3
...
void Rotation0()
{
    ...
    {
        RB1 = 1;
        _delay((unsigned long)((900)*(16000000/4000000.0)));
        RB1 = 0;
        _delay((unsigned long)((19100)*(16000000/4000000.0)));
    }
    isOpened = 0;
}
...
void Rotation90()
{
    ...
    {
        RB1 = 1;
        _delay((unsigned long)((1950)*(16000000/4000000.0)));
        RB1 = 0;
        _delay((unsigned long)((18050)*(16000000/4000000.0)));
    }
    isOpened = 1;
}
