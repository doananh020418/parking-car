...
# 6 "C:\\Program Files\\Microchip\\xc8\\v2.30\\pic\\include\\c90\\string.h" 2 3

# 1 "C:/Program Files (x86)/Microchip/MPLABX/v5.40/packs/Microchip/PIC16Fxxx_DFP/1.2.33/xc8\\pic\\include\\__null.h" 1 3
# 7 "C:\\Program Files\\Microchip\\xc8\\v2.30\\pic\\include\\c90\\string.h" 2 3
...
unsigned int checkID(unsigned char id[12]){
    for (int i=0;i<numberID;i++){
        if (strcmp((unsigned char)eeprom_read(i),id)==1){
            return 1;
        }
    }
    return 0;
...
void Rotation0()
{
    ...
    {
        RB1 = 1;
        _delay((unsigned long)((800)*(4000000/4000000.0)));
        RB1 = 0;
